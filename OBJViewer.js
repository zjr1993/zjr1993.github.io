...
function mainss() {
  ...
  gl.clearColor(0.69,0.76,0.87, 1.0);
  ...
  readOBJFile('xlmmv1.obj', gl, model, 0.008, true);
...
function draw(gl, program, angle, viewProjMatrix, model) {
  ...
  g_modelMatrix.setRotate(180, 0.0, 1.0, 0.0); // 適当に回転
  g_modelMatrix.rotate(angle[0], 0.1, 0.0, 0.0);
  g_modelMatrix.rotate(angle[1], 0.0, 0.1, 0.0);
